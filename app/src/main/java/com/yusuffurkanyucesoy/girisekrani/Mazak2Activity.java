...
public class Mazak2Activity extends AppCompatActivity {
    ...
    String URL = "http://mtconnect.mazakcorp.com:5611/";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mazak2);
    ...
    private class DownloadXML extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Mazak2Activity.this);
