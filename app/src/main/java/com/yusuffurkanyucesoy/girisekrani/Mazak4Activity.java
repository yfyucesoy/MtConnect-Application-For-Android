...
public class Mazak4Activity extends AppCompatActivity {
    ...
    String URL = "http://mtconnect.mazakcorp.com:5609/";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mazak4);
    ...
    private class DownloadXML extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Mazak4Activity.this);
